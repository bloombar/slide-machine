...
- ⬜ Outstanding: `BILL-1..7` + Stripe + metering; `PREP-1/2/3/4` (preflight + verbal); GitHub sign-in + connect; `TECH-12` (i18n) + `SHARE-2` (translation); `IMG-4` (AI imagery); `P-11` (retention purge sweep); `P-1..P-9` hardening, reduced-motion a11y, 100% coverage gate.
